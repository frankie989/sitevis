...
//функция обработки текста в аудио дорожку.
function test() {
    VoiceRSS.speech({
        key: '48c61fc4a7af4da5b86ae0df0cea8010',
        src: 'Hello, my name Aleksey Filatov and i really want to work in your company! I am still a beginner, but i am trying very hard to become a professional!',
        hl: 'en-us',
        v: 'Linda',
        r: 0,
        c: 'mp3',
...
//кнопка резюме с вопросом закачки
...
// Шуточная форма опросник работа кнопок
